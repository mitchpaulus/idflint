...
/// <summary>
/// This class provides an empty implementation of <see cref="IIdfListener"/>,
/// which can be extended to create a listener which only needs to handle a subset
/// of the available methods.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("ANTLR", "4.8")]
[System.CLSCompliant(false)]
public partial class IdfBaseListener : IIdfListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="IdfParser.idf"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterIdf([NotNull] IdfParser.IdfContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterObject([NotNull] IdfParser.ObjectContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterFields([NotNull] IdfParser.FieldsContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="IdfParser.fields"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitFields([NotNull] IdfParser.FieldsContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="IdfParser.field"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterField([NotNull] IdfParser.FieldContext context) { }
	/// <summary>
